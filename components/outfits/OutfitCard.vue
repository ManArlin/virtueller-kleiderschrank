<template>
    <div>
        <b-card v-if="outfit" border-variant="secondary" :title="outfit.name"
        :subtitle="outfit.occasion.toString()" footer-tag="footer" align="center">
            <b-card-text>
                Kleidungsstücke:
                <!--Nested Card Group to show all Clothes-->
